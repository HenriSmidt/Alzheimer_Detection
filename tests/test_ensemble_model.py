...
class TestEnsembleModels(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.mobilevit_wrapper = MobileViTWrapper(
            model_ckpt="apple/mobilevit-small", num_labels=cls.num_labels
        )
        cls.efficientnet_wrapper = EfficientNetWrapper(
            model_name="efficientnet-b0", num_classes=cls.num_classes
        )
    ...
    def test_simple_ensemble_model_creation(self):
        ...
        simple_model = create_ensemble_model(
            self.model_wrappers, self.num_classes, use_advanced=False
        )
    ...
    def test_advanced_ensemble_model_creation(self):
        ...
        advanced_model = create_ensemble_model(
            self.model_wrappers, self.num_classes, use_advanced=True
        )
