...
class TestMobileViTLightning(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertIsNotNone(
            self.model.model, "The underlying MobileViT model should not be None."
        )
        self.assertIsNotNone(
            self.model.feature_extractor, "The feature extractor should not be None."
        )
    ...
    def test_forward_pass(self):
        ...
        self.assertEqual(
            logits.shape,
            torch.Size([1, 1000]),
            "Output logits should have shape [1, 1000]",
        )
